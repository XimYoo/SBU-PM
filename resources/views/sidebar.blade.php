  ...
  <style>
    /* Styling hover untuk item navigasi sidebar */
    .nav-item .nav-link {
      transition: all 0.3s ease;
    }
  
    /* Warna latar belakang dan teks saat elemen di-hover */
    .nav-item .nav-link:hover {
      background-color: #f0f1f5; /* Warna latar belakang saat di-hover */
      color: #5e72e4; /* Warna teks saat di-hover */
    }
  
    /* Mengubah warna ikon ketika di-hover */
    .nav-item .nav-link:hover .icon {
      background-color: #e0e4ea; /* Warna latar belakang ikon saat di-hover */
      color: #5e72e4; /* Warna ikon saat di-hover */
    }
  
    /* Hover styling untuk teks di dalam link */
    .nav-item .nav-link:hover .nav-link-text {
      color: #5e72e4; /* Warna teks saat di-hover */
    }
  
    /* Transisi untuk perubahan ikon dan teks */
    .icon, .nav-link-text {
      transition: all 0.3s ease;
    }
  
    /* Tambahan hover untuk tombol upgrade dan kartu bantuan */
    .btn.bg-gradient-primary:hover {
      background-color: #4a5db5; /* Warna saat tombol di-hover */
    }
  
    .sidenav-footer .card-body:hover {
      background-color: rgba(255, 255, 255, 0.1); /* Efek hover untuk card di footer */
    }
  </style>
